  ...
  node('skopeo-pod') {
    ...
    dir('openshift-tasks') {
      ...
      stage('Copy Image to Nexus container registry') {
        ...
        sh "skopeo copy --src-tls-verify=false --dest-tls-verify=false --src-creds openshift:\$(oc whoami -t) --dest-creds admin:admin docker://docker-registry.default.svc:5000/${devProject}/tasks:${devTag} docker://nexus3-registry.gpte-hw-cicd.svc.cluster.local:5000/tasks:${devTag}"
